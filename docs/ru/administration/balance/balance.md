...
В квотах на общий объем и количество дисков в проекте учитываются диски всех типов. Отдельно задаются квоты на объем и количество дисков типов High-IOPS SSD и Ceph.
