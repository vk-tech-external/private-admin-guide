...
Чтобы просмотреть все имеющиеся пулы в кластере, выполните команду:
...
1. Отключите сервисы, функционирующие на узле OSD, выполнив команду:
   ...
   В примерах текущей инструкции приведены узлы с OSD под номерами `0`, `2`, `4`, `6`.
...
1. Удалите OSD из Crush maps, выполнив команду:
...
1. Удалите сервисы OSD, выполнив команду:
...
1. Перейдите по SSH на CSN-сервер, откуда требуется вывести узел.
1. Отключите службу, отвечающую за работу MDS-сервиса, выполнив команду:
...
Чтобы просмотреть содержимого RBD-пула, выполните команду:
...
Чтобы удалить RBD-пул, выполните команду:
...
Чтобы просмотреть информацию по RBD-диску, выполните команду:
...
Чтобы удалить RBD-диск, выполните команду:
