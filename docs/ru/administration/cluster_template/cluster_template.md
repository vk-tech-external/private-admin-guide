...
После создания новой внешней сети проекта, доступной только в нём, создайте шаблон кластера Kubernetes. Запустите плейбуки с параметрами:
...
Для работы с шаблонами кластера Kubernetes укажите идентификатор проекта, для которого создана внешняя сеть, доступная только в нём:
...
1. Укажите идентификатор проекта:
   ...
   Здесь `<PROJECT_ID>` — идентификатор проекта, для которого создана внешняя сеть, доступная только в нём.
