...
* Стандартизация разработки в распределённых командах и при работе с аутсорсерами.
...
#### {heading(Получение объединённых настроек `kubeconfig`)[id=combined_kubeconfig_settings]}
