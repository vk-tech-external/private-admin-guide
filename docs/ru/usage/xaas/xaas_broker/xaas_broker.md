...
* `user_id` — email пользователя, на который будут приходить уведомления об ошибках при создании инстансов сервиса.
...
|201
|Брокер (SaaS-брокер или тенант image-based брокера) зарегистрирован в Marketplace.
