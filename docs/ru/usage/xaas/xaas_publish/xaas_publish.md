...
Сервис перенесен из открытого пространства в тестовое, указанное при регистрации брокера в Marketplace (подробнее — в разделе {linkto(../../../usage/xaas/xaas_broker#xaas_broker_register)[text=%text]})
