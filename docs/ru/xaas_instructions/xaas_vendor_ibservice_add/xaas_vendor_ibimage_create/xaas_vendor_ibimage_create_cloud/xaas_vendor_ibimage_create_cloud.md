...
1. Установите ПО на ВМ:
   ...
   1. Подключитесь к ВМ через SSH:
      ...
      * `<USER_NAME>` — имя пользователя ОС. Укажите имя в зависимости от ОС. Список имён приведёно в **Руководстве пользователя {var(system)}** в разделе **Подключение к ВМ**.
...
1. Очистите ВМ от чувствительных данных:
   ...
   * Для ОС Red Hat Enterprise Linux (CentOS, AlmaLinux, Rocky Linux) выполните команды:
...
1. Создайте образ сервиса на основе диска ВМ:
   ...
   1. Выберите диск созданной и настроенной ВМ.
      ...
      Имя диска ВМ отображается на её странице на вкладке **Диски**.
