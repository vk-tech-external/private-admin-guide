...
![Тарифная опция типа string с вводом значения](../../../../xaas_instructions/xaas_vendor_ibservice_add/xaas_vendor_ibservice_configure/xaas_vendor_iboption/assets/xaas_option_string_input.png){params[width=50%]}
{/caption}
...
![Тарифная опция-константа типа boolean (const = false)](../../../../xaas_instructions/xaas_vendor_ibservice_add/xaas_vendor_ibservice_configure/xaas_vendor_iboption/assets/xaas_option_bool_const.png){params[width=50%]}
{/caption}
...
![Тарифная опция-переключатель boolean](../../../../xaas_instructions/xaas_vendor_ibservice_add/xaas_vendor_ibservice_configure/xaas_vendor_iboption/assets/xaas_option_bool.png){params[width=50%]}
{/caption}
