...
При локальном тестировании используйте подсети существующих сетей или создайте новую сеть и используйте ее подсеть (подробнее — в **Руководстве пользователя {var(system)}** в разделе **Виртуальные сети**).
...
1. Обратитесь к администратору {var(sys2)}, чтобы получить плагин провайдера iVK CS. Сообщите ОС компьютера, на котором будете локально тестировать манифест, и ее архитектуру (например, Linux на архитектуре amd64).
