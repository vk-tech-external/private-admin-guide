...
При локальном тестировании используйте подсети существующих сетей или создайте новую сеть и используйте её подсеть (подробнее — в **Руководстве пользователя {var(system)}** в разделе **Виртуальные сети**).
