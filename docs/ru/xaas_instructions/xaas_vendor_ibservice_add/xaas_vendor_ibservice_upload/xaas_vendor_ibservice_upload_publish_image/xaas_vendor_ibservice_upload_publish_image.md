...
Чтобы опубликовать образ сервиса на {var(sys3)}:
...
1. Чтобы загрузить в Marketplace сервисный пакет с ID публичного образа сервиса, выполните запрос к сервису Infra API, приведенный в разделе {linkto(../../../../xaas_instructions/xaas_vendor_ibservice_add/xaas_vendor_ibservice_upload/xaas_vendor_ibservice_upload_package#xaas_vendor_ibservice_upload_package)[text=%text]}.