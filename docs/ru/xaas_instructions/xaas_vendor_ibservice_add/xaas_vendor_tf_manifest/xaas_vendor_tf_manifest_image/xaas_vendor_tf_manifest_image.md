...
Если в параметре `pool` указать одно фиксированное значение независимо от типа SDN, это приведет к ошибке при разворачивании инстанса сервиса в проектах с другим типом SDN.
