...
1. Создайте ВМ из загрузочного образа сервиса. Используйте ресурс `vkcs_compute_instance`.
   ...
   resource "vkcs_compute_instance" "compute" {
     ...
     block_device {
       ...
       # Тип тома диска
       boot_index            = 0
       # Если указано значение true, диск будет удалён при удалении ВМ
...
Если в параметре `pool` указать одно фиксированное значение независимо от типа SDN, это приведёт к ошибке при разворачивании инстанса сервиса в проектах с другим типом SDN.
