...
Автовосстановление позволяет на основании данных мониторинга без дополнительных действий со стороны пользователя выполнить повторное развертывание ВМ с инстансом сервиса, если они вышли из строя.
