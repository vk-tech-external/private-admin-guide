# {appendix-heading(Описание выходных параметров)[id=xaas_vendor_tf_manifest_output; position=prefix]}

Опишите выходные параметры, чтобы передать их пользователю по электронной почте после выполнения манифеста и развертывания сервиса.
