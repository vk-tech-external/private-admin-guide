...
Опишите входные переменные для конфигурации ресурсов. Переменные можно условно поделить на группы, приведенные в {linkto(#tab_terraform_variables)[text=таблице %number]}.
