...
Провайдер iVK CS предоставляет источник данных `ivkcs_agent_script_result` — получение форматированного результата скрипта, выполненного в агенте. Позволяет получить данные в процессе развертывания сервиса, передать их в Terraform и использовать в дальнейших действиях для развертывания сервиса.
