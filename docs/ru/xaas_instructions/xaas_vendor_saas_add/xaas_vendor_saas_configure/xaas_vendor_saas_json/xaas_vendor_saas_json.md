...
* Секция `plans` — описывает тарифные планы и их опции (подробнее — в подразделе {linkto(../../../../xaas_instructions/xaas_vendor_saas_add/xaas_vendor_saas_configure/xaas_vendor_saas_plan#xaas_vendor_saas_plan_structure)[text=%text]}).

Пример JSON-файла приведен в разделе {linkto(../../../../xaas_instructions/xaas_vendor_saas_example#xaas_vendor_saas_example)[text=%text]}.