...
У пользователя, загружающего сервис в Marketplace, должна быть учетная запись (личный кабинет) на {var(sys6)}.
...
![Загрузка SaaS-приложения](./assets/xaas_saas_upload.png){params[width=100%;noBorder=true]}
{/caption}