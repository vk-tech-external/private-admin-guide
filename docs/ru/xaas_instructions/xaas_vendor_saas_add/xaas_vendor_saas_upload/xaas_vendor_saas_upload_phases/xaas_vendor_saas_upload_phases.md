...
У пользователя, загружающего сервис в Marketplace, должна быть учётная запись (личный кабинет) в {var(sys6)}. Инструкция по регистрации приведена в **Руководстве пользователя {var(system)}** в разделе **Подготовка к работе**.
...
![Загрузка SaaS-приложения](./assets/xaas_saas_upload.png){params[width=100%]}
{/caption}