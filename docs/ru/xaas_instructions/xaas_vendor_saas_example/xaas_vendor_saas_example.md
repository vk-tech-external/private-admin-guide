# {appendix-heading(Пример JSON-файла для SaaS-приложения)[id=xaas_vendor_saas_example; position=prefix]}
                ...
                "parameters": {
                  ...
                  "properties": {
                    ...
                    "report_notifications": {
                      ...
                      "hint": "Настройка мгновенных уведомлений для сотрудников компании о появлении новых отчётов.",
                      "const": false
                    }
                  }
                }
