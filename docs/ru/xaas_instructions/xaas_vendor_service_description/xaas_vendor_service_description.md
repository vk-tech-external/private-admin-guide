...
Если image-based приложение использует инфраструктуру {var(sys2)}, объем и стоимость которой невозможно определить на момент подключения сервиса (например, хранение накапливаемой по мере работы информации — бэкапы), сообщите об этом в описании правил тарификации.
